...
function parse(input) {
    ...
    function maybe_call(expr) {
        expr = expr();
        return isPunc("(") ? parse_call(expr) : expr;
    }
    function parse_atom() {
...
function evaluate(exp, env) {
    switch (exp.type) {
      ...
      case "binary":
        return applyOperator(exp.operator,
...
var code = 'print_range = ^(a, b) if a <= b {print(a);if a + 1 <= b {print(", ");print_range(a + 1, b);} else println(""); }; print_range(1, 10);'
